...
The function `anisotropic.fit` streamlines model fitting and does not require `anisodistfn` to be defined externally. For example,
```{r anisoexample2, cache = TRUE}
