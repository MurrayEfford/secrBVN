...
The method does not work if the detector array is strictly linear (2-D data are required to estimate elongation). It is tested below on a hollow square array. This is the only time in this vignette that we attempt to *fit* elongated ranges rather than circular ranges.

```{r anisotropic, eval = runall, echo = TRUE}
...
```{r sumplotaniso, echo = TRUE, eval = FALSE}
